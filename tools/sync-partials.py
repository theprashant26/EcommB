...
PAGES = ["shop.html", "product.html", "brand.html", "origin.html", "about.html", "rituals.html", "wishlist.html"]
...
def with_lcp(page, html):
    ...
    if page != "product.html":
        return html
    pairs = ",".join(f'"{k}":"{v}"' for k, v in lcp_map().items())
    script = ('<script>(function(m){var s=m[new URLSearchParams(location.search).get("id")];if(!s)return;'
